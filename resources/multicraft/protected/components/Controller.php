...
class Controller extends CController
{
    ...
    public function init()
    {
        ...
        if (!Yii::app()->theme || !strlen(Yii::app()->theme->name) || Yii::app()->theme == 'default')
            Yii::app()->theme = 'centered';
...
<?php endif ?>
    ...
    <?php if (@Yii::app()->params['delay_daemon_queries']): ?>
        refresh('all');
    <?php else: ?>
        scheduleRefresh();
    <?php endif ?>
