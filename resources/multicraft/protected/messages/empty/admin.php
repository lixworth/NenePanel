...
return array (
  ...
  'Config file not writable, settings will not be saved: protected/config/server_defaults.php' => '',
  'Configuration' => '',
  'Console' => '',
  ...
  'Default server IP' => '',
  'Default server name' => '',
  'Delay daemon queries (only use AJAX)' => '',
  ...
  'Format: Min-Max, for example: 5000-10000.' => '',
  'Function disabled in demo mode.' => '',
  'Generate server status banners (requires GD)' => '',
  'Global Operations' => '',
  'Go' => '',
  'Here you can define the default settings used for new servers. These defaults are also used when creating a server through the API (i.e. using a billing system).' => '',
  ...
  'Number of additional ports to allow' => '',
  ...
  'Skip querying any daemon data until after the page has fully loaded. Daemon data will be loaded in using AJAX updates' => '',
  'Start' => '',
  'Statistics' => '',
  'Status' => '',
  'Stop' => '',
  ...
  'Suspend' => '',
  'Suspended Servers' => '',
  'The classic backup functionality' => '',
  ...
  'Theme' => '',
  'This allows users to reserve additional ports for their server and route them to their Docker container. 0 to disable.' => '',
  ...
  'This requires daemon configuration' => '',
  ...
  'Use legacy FTP client zip functionality (zip on webserver)' => '',
