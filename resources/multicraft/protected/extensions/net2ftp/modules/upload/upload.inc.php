...
// Include
	echo "<script type=\"text/javascript\" src=\"".Theme::js('net2ftp/upload.js')."\"></script>\n";
...
// ---------------------------------------
		if (($uploadedFilesArray && sizeof($uploadedFilesArray) > 0) || ($uploadedArchivesArray && sizeof($uploadedArchivesArray) > 0)) {
