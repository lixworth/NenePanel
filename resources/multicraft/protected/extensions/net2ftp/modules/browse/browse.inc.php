...
// --------------
	...
	setcookie("net2ftpcookie_ftpserver",     $net2ftp_globals["ftpserver"],     $cookie_expire, '', '', false, true);
	setcookie("net2ftpcookie_ftpserverport", $net2ftp_globals["ftpserverport"], $cookie_expire, '', '', false, true);
	setcookie("net2ftpcookie_username",      $net2ftp_globals["username"],      $cookie_expire, '', '', false, true);
	setcookie("net2ftpcookie_language",      $net2ftp_globals["language"],      $cookie_expire, '', '', false, true);
	setcookie("net2ftpcookie_skin",          $net2ftp_globals["skin"],          $cookie_expire, '', '', false, true);
	setcookie("net2ftpcookie_ftpmode",       $net2ftp_globals["ftpmode"],       $cookie_expire, '', '', false, true);
	setcookie("net2ftpcookie_passivemode",   $net2ftp_globals["passivemode"],   $cookie_expire, '', '', false, true);
	setcookie("net2ftpcookie_protocol",      $net2ftp_globals["protocol"],      $cookie_expire, '', '', false, true);
	setcookie("net2ftpcookie_viewmode",      $net2ftp_globals["viewmode"],      $cookie_expire, '', '', false, true);
	setcookie("net2ftpcookie_sort",          $net2ftp_globals["sort"],          $cookie_expire, '', '', false, true);
	setcookie("net2ftpcookie_sortorder",     $net2ftp_globals["sortorder"],     $cookie_expire, '', '', false, true);
	setcookie("net2ftpcookie_directory",     $net2ftp_globals["directory"],     $cookie_expire, '', '', false, true);
...
// -------------------------------------------------------------------------
	if ($net2ftp_globals["skin"] == "mobile" || $net2ftp_globals["skin"] == "iphone") {
		echo "<script type=\"text/javascript\" src=\"". $net2ftp_globals["application_rootdir_url"] . "/net2ftp/js/browse_main_mobile.js\"></script>\n";
	}
...
// ------------------------------------
		if ($net2ftp_globals["state2"] == "main") {
			echo "<script type=\"text/javascript\" src=\"".Theme::js('net2ftp/browse_main.js')."\"></script>\n";
		}

		if ($net2ftp_globals["state2"] == "popup") {
			echo "<script type=\"text/javascript\" src=\"".Theme::js('net2ftp/browse_popup.js')."\"></script>\n";
		}
...
// --------------
	...
	echo "<link rel=\"stylesheet\" type=\"text/css\" href=\"".Theme::css('net2ftp.css')."\" />\n";
...
// ------------------------------------
	...
	$icon_directory = Theme::themeFile('images/net2ftp/mime');
...
// Now, print the full HTML depending on the browser agent, version and platform
		if ($icon != "") {
			if ($net2ftp_globals["browser_agent"] == "IE" && ($net2ftp_globals["browser_version"] == "5.5" || $net2ftp_globals["browser_version"] == "6") && $net2ftp_globals["browser_platform"] == "Win") {
				$sortArray[$key]["icon"] = "<img src=\"$icon_directory/spacer.gif\"   alt=\"$alt\" class=\"sort-icon\" style=\"border: 0px; filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src='".Theme::themeFile('images/'.$icon)."', sizingMethod='scale');\" />\n";
			} 
			else { 
				$sortArray[$key]["icon"] = Theme::img($icon, $alt, array('class'=>'sort-icon')); 
			}
		}
		else {
				$sortArray[$key]["icon"] = "";
